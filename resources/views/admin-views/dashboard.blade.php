...
<div class="content container-fluid">
    ...
    <div class="page-header" style="padding-bottom: 0!important;border-bottom: 0!important;margin-bottom: 1.25rem!important;">
        <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title">welcome, {{ Auth::user()->f_name}}.</h1>
                <p>welcome_message</p>
            </div>
    ...
    <div class="card card-body mb-3 mb-lg-5">
        <div class="row gx-2 gx-lg-3 mb-2">
            <div class="col-9">
                <h4><i style="font-size: 30px" class="tio-chart-bar-4"></i>dashboard_order_statistics</h4>
            </div>
            <div class="col-3">
                        ...
                        <div class="col-md-4 graph-border-1">
                            <div class="mt-2 center-div">
                                <span class="h6 mb-0">
                                    ...
                                    earnings : {{ \App\CentralLogics\Helpers::set_symbol(array_sum($earning)) }}
                                </span>
                            </div>
                        </div>
                    </div>
    ...
    <script src="assets/admin/vendor/chart.js.extensions/chartjs-extensions.js"></script>
