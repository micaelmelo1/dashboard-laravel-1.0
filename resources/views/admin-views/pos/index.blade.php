...
<body class="footer-offset">
        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('admin.dashboard')}}" aria-label="Front" style="padding-top: 0!important;padding-bottom: 0!important;">
                    <img class="navbar-brand-logo" style="border-radius: 50%;height: 55px;width: 55px!important; border: 5px solid #80808012" onerror="this.src='{{asset('public/assets/admin/img/160x160/img2.jpg')}}'" src="{{asset('storage/app/public/product')}}/" alt="Logo">
                </a>
            ...
            <div class="navbar-nav-wrap-content-right">
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    <li class="nav-item d-none d-sm-inline-block">
                        <!-- Notification -->
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle" href="{{route('admin.orders.list',['status'=>'pending'])}}">
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;" data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" onerror="this.src='{{asset('public/assets/admin/img/160x160/img1.jpg')}}'" src="{{asset('storage/app/public/branch')}}/" alt="Image">
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        <div class="avatar avatar-sm avatar-circle mr-2">
                                            <img class="avatar-img" onerror="this.src='{{asset('public/assets/admin/img/160x160/img1.jpg')}}'" src="{{asset('storage/app/public/branch')}}/" alt="Owner image">
                                        </div>
    ...
    <script>
            ...
            $('.input-number').change(function() {
                ...
                if (valueCurrent >= minValue) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Cart',
                        text: '{{\App\CentralLogics\translate('
                        Sorry,
            ...
            if (checkAddToCartValidity()) {
                ...
                $.post({
                    ...
                    success: function(data) {
                        ...
                        toastr.success('{{\App\CentralLogics\translate('
            ...
            $.post('{{ route('
                ...
                function(data) {
                    if (data.errors) {
                        ...
                        updateCart();
                        toastr.info('{{\App\CentralLogics\translate('
        ...
        function store_key(key, value) {
            ...
            $.post({
                url: '{{route('
                admin.pos.store - keys ')}}',
                data: {
                    key: key,
                    value: value,
                },
                success: function(data) {
                    toastr.success(key + ' ' + '{{\App\CentralLogics\translate('
                        selected ')}}!', {
                            CloseButton: true,
                            ProgressBar: true
                        });
