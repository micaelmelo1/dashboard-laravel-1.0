...
<body class="footer-offset">
            ...
            <div class="col-md-12">
                <div id="loading" style="display: none;">
                    <div style="position: fixed;z-index: 9999; left: 40%;top: 37% ;width: 100%">
                        <img width="200" src="assets/admin/img/loader.gif">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <center>
                                    ...
                                    <hr>
                                    <button onclick="" class="btn btn-primary">Ok, let me check</button>
                                </center>
                            </div>
                        </div>
                    </div>
    ...
    @stack('script_2')
    <audio id="myAudio">
        <source src="assets/admin/sound/notification.mp3" type="audio/mpeg">
    </audio>
    ...
    <!-- IE Support -->
    <script>
        if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src=" assets / admin /vendor/babel-polyfill/polyfill.min.js"><\/script>');
    </script>
</body>
