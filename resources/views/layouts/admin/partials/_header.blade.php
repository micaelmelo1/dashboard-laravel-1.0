        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="" aria-label="">
                    <img class="navbar-brand-logo" onerror="this.src='assets/admin/img/160x160/img1.jpg'" src="storage/app/public/restaurant/'.$restaurant_logo" alt="Logo">
                    <img class="navbar-brand-logo-mini" onerror="this.src='assets/admin/img/160x160/img1.jpg'" src="storage/app/public/restaurant/'.$restaurant_logo" alt="Logo">
                </a>
                <!-- End Logo -->
            </div>
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;" data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" onerror="this.src='assets/admin/img/160x160/img1.jpg'" src="storage/app/public/admin/{{Auth::user()->image}}" alt="Image Description">
